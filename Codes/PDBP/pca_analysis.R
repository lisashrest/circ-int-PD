...
details <- read.csv("sample_details.csv", stringsAsFactors = TRUE, header = TRUE)
details$filename <- paste0(details$Sample.Participant, "_", details$Visit)
rownames(details) <- details$filename


details$Family_History <- factor(details$fampd,
                                 levels = c("1", "2", "3", "NA"), 
                                 labels = c("1st-degree", "2nd-degree", "No History", "NA"))
...
dds <- DESeqDataSetFromMatrix(countData = bsj_mtx_final,
                              colData = details,
                              design = ~ Sample.Participant + EVENT_ID)
dds

#Pre-filtering
keep <- rowSums(counts(dds) >= 2) >= 63
dds <- dds[keep,]
dds
...
S1_a <- plotPCA(vsd, intgroup = "Enroll.Age.at.Baseline", ntop = 500)+
  labs(colour = "Age")+
...
S1_b <- plotPCA(vsd, intgroup = "Enroll.Sex", ntop = 500)+
  labs(colour = "Sex")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
S1_e <- plotPCA(vsd, intgroup = "Enroll.Race", ntop = 500)+
  labs(colour = "Race")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
S1_f <- plotPCA(vsd, intgroup = "HY.Stage", ntop = 500)+
...
cowplot::plot_grid(S1_d, S1_e, 
                   labels = c("c","d"),
                   ncol = 2, nrow = 1, label_size = 20)

cowplot::plot_grid(S1_f, 
                   labels = c("e"),
                   ncol = 2, nrow = 1, label_size = 20)
...
S2_g <- plotPCA(vsd, intgroup = "Enroll.Age.at.Baseline", ntop = 500)+
  labs(colour = "Age")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18), 
...
S2_h <- plotPCA(vsd, intgroup = "Enroll.Sex", ntop = 500)+
  labs(colour = "Sex")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
S2_i <- plotPCA(vsd, intgroup = "Family_History", ntop = 500)+
  labs(colour = "Family History")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
S2_j <- plotPCA(vsd, intgroup = "Enroll.Race", ntop = 500)+
  labs(colour = "Race")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
S2_k <- plotPCA(vsd, intgroup = "HY.Stage", ntop = 500)+
  labs(colour = "HY Stage")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
cowplot::plot_grid(S2_k, 
                   labels = c("e"),
                   ncol = 2, nrow = 1, label_size = 20)

#Checking lower PCs
S2_g <- plotPCA.san(vsd, intgroup = "Enroll.Age.at.Baseline", ntop = 500)+
  labs(colour = "Age")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18), 
...
S2_h <- plotPCA.san(vsd, intgroup = "Enroll.Sex", ntop = 500)+
  labs(colour = "Sex")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
S2_i <- plotPCA.san(vsd, intgroup = "Family_History", ntop = 500)+
  labs(colour = "Family History")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
S2_j <- plotPCA.san(vsd, intgroup = "Enroll.Race", ntop = 500)+
  labs(colour = "Race")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
S2_k <- plotPCA.san(vsd, intgroup = "HY.Stage", ntop = 500)+
  labs(colour = "HY Stage")+
  theme(legend.title = element_text(size = 18),
        axis.title = element_text(size = 20),
        axis.text = element_text(size = 18),
...
#Plot Grid plots
cowplot::plot_grid(S2_g, S2_h, S2_i, S2_j, S2_k,
                   labels = c("a","b","c","d","e"),
